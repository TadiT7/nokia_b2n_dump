#!/vendor/bin/sh
panel="qdcm_calib_data_ili7807e_1080p_video_mode_dsi_panel.xml"
qdcm_path="/data/vendor/display/qdcm_calib_data_ili7807e_1080p_video_mode_dsi_panel.xml"
ori_qdcm_path="/vendor/etc/"
